...
namespace shops
{
    ...
    public partial class paneladmin : Form
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            Program.connection.Open();
            string query = "DELETE FROM copon WHERE code='" + code_name + "'";
            SqlCommand command = new SqlCommand(query, Program.connection);
            command.ExecuteNonQuery();
            Program.connection.Close();
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            string code_name = textBox12.Text;
            string percent = textBox11.Text;
            ...
            // ایجاد کوئری
            var query1 = new SqlCommand("UPDATE copon SET percent = @percent WHERE code = @code_name", Program.connection);

            // قرار دادن مقادیر در کوئری
            query1.Parameters.AddWithValue("@code_name", percent);
            query1.Parameters.AddWithValue("@percent", percent);
